      ...
      <div class="header-container container">
        ...
        <div class="header-contacts">
          ...
          <div class="contact contact-one">
            ...
            <div class="right pad">
              <p>Email Us:</p>
              <p>info@dialalwayerafrica.com</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <nav>
      <div class="nav-container container">
        ...
        <div class="links" id="links">
          ...
          <a href="/#courts">Know Your Courts</a>
            ...
            <div class="research-information one">
              ...
              <div class="research-card">
                ...
                <p>
                  ...
                  provide easy access to legal advice and help advocates and
                  individuals navigate the complex legal system in Africa. We
                  help you stay informed and provide legal assistance to help
                  you make informed decisions. With Dial a Lawyer Africa, you'll
...
.card {
  width: 300px; /* adjust this to fit your card width */
  margin-right: 10px; /* adjust this to fit your desired spacing between cards */
}

.card img {
  width: 100%;
  height: 200px; /* adjust this to fit your desired card height */
  object-fit: cover;
}
