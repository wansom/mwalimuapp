<template>
    <nav class="dash-nav">
      <div class="ins-lg">
        <div class="dash-lg">
          <img
            ...
            alt=""
            class="h-100 object-contain w-50"
            style="height: 120px;"
          />
        </div>
      ...
      <div class="nav-profile">
            ...
            <div class="help-icon">
              ...
              >
                ...
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M8.03975 11.1809V8.21846V11.1809Z"
                  fill="#0066F9"
                />
                <path
                  d="M8.03975 11.1809V8.21846"
                  stroke="white"
                  stroke-width="1.48112"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                ...
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M8.04317 5.56283H8.03633H8.04317Z"
                  fill="#0066F9"
                />
                <path
                  d="M8.04317 5.56283H8.03633"
                  stroke="white"
                  stroke-width="1.48112"
                  stroke-linecap="round"
                  stroke-linejoin="round"
        ...
        <div class="profile">
          <div class="pr-img">
            <img src="/images/Profile.png" alt="Insurance profile image" />
          ...
          <div class="pr-drpdwn">
            <button class="pr-drpdwn-btn">
              ...
              >
                <path
                  d="M20.0938 11.0488L11.0454 2.00044L1.99697 11.0488"
                  stroke="#F5F7FF"
